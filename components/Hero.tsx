...
import { ArrowRight, CheckCircle, Code, Medal, Lightning } from '@phosphor-icons/react'
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 w-full py-20 pt-32 lg:pt-36">
        <div className="grid grid-cols-1 lg:grid-cols-[56%_44%] items-center gap-16 lg:gap-0">
          ...
          >
            ...
            <motion.h1
              variants={item}
              className="text-[52px] md:text-[60px] lg:text-[66px] font-bold tracking-tighter leading-[1.03] text-slate-900 dark:text-white mb-6"
            >
              Del cero al{' '}
              <br />
              primer{' '}
              <span className="text-[#00CED1]">deployment.</span>
              <br />
              Con alguien
              <br />
              al lado.
            ...
            >
              Desarrollamos aplicaciones web para empresas y guiamos a
              profesionales que quieren construir una carrera en tecnología.
              Sin rodeos. Sin conceptos vacíos.
            </motion.p>
              ...
              <div className="glass-card rounded-2xl p-4 animate-float-b">
                <div className="flex items-center gap-2 mb-2">
                  <div className="w-7 h-7 rounded-lg bg-[#00CED1]/10 flex items-center justify-center">
                    <Medal size={14} className="text-[#00CED1]" weight="fill" />
                  </div>
                  <span className="text-[11px] font-medium text-slate-500 dark:text-slate-400">Experiencia</span>
                </div>
                ...
                <p className="text-[11px] text-[#00CED1] font-medium mt-1">años en el mercado</p>
              </div>
            </motion.div>
            ...
            >
              <div className="glass-card rounded-2xl p-3.5 animate-float-d">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    <p className="text-[12px] font-semibold text-slate-800 dark:text-slate-100 leading-tight">Mentoría 1:1</p>
                    <p className="text-[10px] text-slate-400 dark:text-slate-500 mt-0.5">Disponible esta semana</p>
                  </div>
                </div>
